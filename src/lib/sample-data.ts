...
export let sampleRequests: Request[] = [
  ...
  },
  {
    ...
    summary: "Alta General d'Empleat: Sofia Pons",
    details: { fullName: "Sofia Pons", nif: "12121212S", role: "Analista de Dades", department: "Operacions" },
    requestTypeDefinitionId: "onboarding_general"
  },
  {
    id: "REQ008",
...
export let sampleSystems: System[] = [
  { id: "erp", name: "ERP (Sistema de Planificació de Recursos)", requiresApprovalBy: "Manager Finances" },
  { id: "crm", name: "CRM (Gestió de Relacions amb Clients)", requiresApprovalBy: "Manager Vendes" },
  ...
  { id: "project_management_tool", name: "Eina de Gestió de Projectes", requiresApprovalBy: "Cap de Projecte Assignat" },
